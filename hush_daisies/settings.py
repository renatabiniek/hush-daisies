"""
Django settings for hush_daisies project.
...
ALLOWED_HOSTS = ['hush-daisies.herokuapp.com', 'localhost']
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'hush-daisies'
...
if 'DEVELOPMENT' in os.environ:
    ...
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'hushdaisies@example.com'
else:
